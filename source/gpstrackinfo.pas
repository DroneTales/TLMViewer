...
type
  TfmGpsTrackInfo = class(TForm)
    laMinAltCaption: TLabel;
    laMaxAltCaption: TLabel;
    laMinAlt: TLabel;
    laMaxAlt: TLabel;
    laMinDistCaption: TLabel;
    laMinDist: TLabel;
    laMaxDistCaption: TLabel;
    laMaxDist: TLabel;
    laLengthCaption: TLabel;
    laLength: TLabel;
    laTitle: TLabel;
    btClose: TButton;
    Image: TImage;
    laMinSpeedCaption: TLabel;
    laAvgSpeedCaption: TLabel;
    laMaxSpeedCaption: TLabel;
    laMaxSpeed: TLabel;
    laAvgSpeed: TLabel;
    laMinSpeed: TLabel;
    laSpeedTitle: TLabel;
    laAltitudeSummary: TLabel;
    laHomeDistanceTitle: TLabel;
    laAvgAltCaption: TLabel;
    laAvgAlt: TLabel;
    laAvgDistCaption: TLabel;
    laAvgDist: TLabel;
    laTrackTimeCaption: TLabel;
    laTrackSummaryTitle: TLabel;
    laTrackTime: TLabel;
  end;
